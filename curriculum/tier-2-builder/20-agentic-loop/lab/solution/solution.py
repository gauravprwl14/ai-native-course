"""Lab 20: ReAct Agent from Scratch — Solution"""
import sys
...
class ReActAgent:
    ...
    def _execute_tool(self, tool_name: str, tool_input: dict) -> str:
        """Execute a registered tool safely. Returns result string or error string."""
    ...
    def run(self, task: str) -> str:
        """Run the ReAct loop for a given task. Returns final answer string."""
        ...
        for i in range(self.max_iterations):
            ...
            if response.stop_reason == "tool_use":
                ...
                print(f"[Step {i + 1}] {tool_block.name}({tool_block.input}) -> {result[:80]}")
