...
class BaseAgent:
    ...
    def run(self, task: str) -> str:
        """
        Call the Anthropic API with self.system_prompt and task as the user message.
        ...
        """
        raise NotImplementedError("Implement BaseAgent.run")
...
class Orchestrator:
    ...
    def run(self, topic: str) -> dict:
        ...
        # article = self.writer.run(f"Write a paragraph based on these notes:\n{research}")
